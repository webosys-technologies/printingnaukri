  ...
  <a class="carousel-control right" href="#carousel" data-slide="next">&rsaquo;</a>
		...
		<h3 style="color:#FFA500;">Enjoy building your career with lots of ready jobs!</h3>
			<p>To provide the right opportunity to the every qualified printing professional.</p>   
		</div>  <br>
                <div class="col-md-2">
                    <a href=""  data-toggle="modal" data-target="#myModal" class="btn btn-warning" style="" ><span style="color:white">GO!</span></a>
            </div>
		...
		<div class="container">
                    <div class="col-md-9 col-md-offset-1">
		<h4 style="color:#FFA500;">Welcome to Packaging Naukri</h4><hr style="border-top: 1px solid #ccc;">
			
<h5 style="color:#FFA500;">Objective</h5>
<p>
...
To provide the right opportunity to the every qualified printing professional, to achieve his/her career objective. At the same time to provide the suitable candidate as per employer’s business need and develop a win-win relationship</p>   
                    </div>
                    </div> <br><br>
